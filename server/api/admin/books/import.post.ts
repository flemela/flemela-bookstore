...
export default defineEventHandler(async (event) => {
  // 1. Resolve and verify admin bearer session
  ...
  // 2. Create canonical product via backend bulk endpoint with explicit auth
  ...
  // 3. Attach formats with format-specific compare-at prices with explicit auth
